...
var cream = ['Movies Especially the Thriller, and Drama Genre', 'Gaming with friends and family', 'Spending time with Courtney, and Roux'];
var sprinkles = 'My Interests:';
var ice = 'My Previous Experiences:';
var coco = 'My Skills:';
UpperCase(info.fullname);
console.log(info.career);
console.log(info.description);
console.log(sprinkles);
for (var i = 0; i < cream.length; i++) {
    console.log(cream[i]);
}
